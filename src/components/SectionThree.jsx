  ...
  return (
    <div id="features" className="main min-h-[100vh] py-10">
      ...
      <Feature 
        ...
        para0 = "We bring you exclusive interviews with renowned personalities who are shaping the future of the web3 and crypto space. From thought leaders to innovators, we delve deep into their insights, experiences, and visions for the decentralized future. Get inspired by conversations with luminaries such as <a target='_blank' href='https://twitter.com/MarioNawfal'>Mario Nawfal</a> , <a target='_blank' href='https://twitter.com/AjeetK'>Ajeet Khurana</a>, <a target='_blank' href='https://twitter.com/smtgpt'>Sumit Gupta</a>, and more."
