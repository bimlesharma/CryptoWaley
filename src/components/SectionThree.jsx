  ...
  return (
    <div id="features" className="main min-h-[100vh] py-10">
      <div className="heading text-4xl md:text-5xl lg:text-[3.5rem] flex justify-center px-6 text-cente font-bold">
        <h1 >Nothing less than Excellence</h1>
      </div>
      
      <Feature 
        img = {group}
        heading = "Exclusive Interviews with Industry Icons"
        para0 = "We bring you exclusive interviews with renowned personalities who are shaping the future of the web3 and crypto space. From thought leaders to innovators, we delve deep into their insights, experiences, and visions for the decentralized future. Get inspired by conversations with luminaries such as <a style='color:#7385ff; font-weight: 500; text-decoration: underline;' target='_blank' href='https://twitter.com/MarioNawfal'>Mario Nawfal</a>, <a style='color:#7385ff; font-weight: 500; text-decoration: underline;' target='_blank' href='https://twitter.com/AjeetK'>Ajeet Khurana</a>, <a style='color:#7385ff; font-weight: 500; text-decoration: underline;' target='_blank' href='https://twitter.com/smtgpt'>Sumit Gupta</a>, and more."
