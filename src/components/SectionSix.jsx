  ...
  return (
    <div id="team">
      ...
      <Cards 
        ...
        p={"CEO of CryptoWaley | Ambassador <a style='color:#7385ff; font-weight: 700; text-decoration: underline;' target='_blank' href='https://twitter.com/QBlockchain'>@QBlockchain</a>"}
        img = {rishabh}
